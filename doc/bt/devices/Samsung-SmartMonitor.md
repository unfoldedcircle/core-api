...
| KEY_RIGHT_ALT           | 230        |    |                                                                           |
| KEY_RIGHT_GUI           | 231        |    |                                                                           |
| KEY_MEDIA_PLAY_PAUSE    | 232        |    | NOK: Teleboy                                                              |
| KEY_MEDIA_STOP_CD       | 233        | x  | Ok: Teleboy                                                               |
| KEY_MEDIA_PREVIOUS_SONG | 234        |    |                                                                           |
| KEY_MEDIA_NEXT_SONG     | 235        |    |                                                                           |
| KEY_MEDIA_EJECT_CD      | 236        |    |                                                                           |
| KEY_MEDIA_VOLUME_UP     | 237        | x  |                                                                           |
| KEY_MEDIA_VOLUME_DOWN   | 238        | x  |                                                                           |
| KEY_MEDIA_MUTE          | 239        | x  |                                                                           |
| KEY_MEDIA_WWW           | 240        |    |                                                                           |
| KEY_MEDIA_BACK          | 241        |    |                                                                           |
| KEY_MEDIA_FORWARD       | 242        |    |                                                                           |
| KEY_MEDIA_STOP          | 243        |    | NOK: Teleboy                                                              |
| KEY_MEDIA_FIND          | 244        |    |                                                                           |
...
| CONSUMER_MENU_UP                                    | 0x042      | x  |                                             |
| CONSUMER_MENU_DOWN                                  | 0x043      | x  |                                             |
| CONSUMER_MENU_LEFT                                  | 0x044      | x  |                                             |
| CONSUMER_MENU_RIGHT                                 | 0x045      | x  |                                             |
...
| CONSUMER_PLAY                                       | 0x0B0      | x  | Ok: Teleboy                                 |
| CONSUMER_PAUSE                                      | 0x0B1      | x  | Ok: Teleboy                                 |
| CONSUMER_RECORD                                     | 0x0B2      |    | NOK: Teleboy                                |
| CONSUMER_FAST_FORWARD                               | 0x0B3      | ?  | NOK: Teleboy -> retest                      |
| CONSUMER_REWIND                                     | 0x0B4      | x  | Ok: Teleboy                                 |
| CONSUMER_SCAN_NEXT_TRACK                            | 0x0B5      |    | NOK: Teleboy                                |
| CONSUMER_SCAN_PREVIOUS_TRACK                        | 0x0B6      |    | NOK: Teleboy                                |
| CONSUMER_STOP                                       | 0x0B7      | x  | Ok: Teleboy                                 |
...
| CONSUMER_PLAY_PAUSE                                 | 0x0CD      | ?  | NOK: Teleboy                                |
